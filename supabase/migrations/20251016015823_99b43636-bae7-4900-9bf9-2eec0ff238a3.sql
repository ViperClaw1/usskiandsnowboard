...
-- Drop existing athlete_profiles policies
...
DROP POLICY IF EXISTS "Athletes can create their own profile" ON public.athlete_profiles;
DROP POLICY IF EXISTS "Employers can view public athlete profiles" ON public.athlete_profiles;
...
-- Drop existing education policies
DROP POLICY IF EXISTS "Athletes can manage their own education" ON public.education;
DROP POLICY IF EXISTS "Employers can view education for public profiles" ON public.education;
...
-- Drop existing experience policies
DROP POLICY IF EXISTS "Athletes can manage their own experience" ON public.experience;
DROP POLICY IF EXISTS "Employers can view experience for public profiles" ON public.experience;
...
-- Drop existing certifications policies
DROP POLICY IF EXISTS "Athletes can manage their own certifications" ON public.certifications;
DROP POLICY IF EXISTS "Employers can view certifications for public profiles" ON public.certifications;
...
-- Drop existing employer_profiles policies
...
DROP POLICY IF EXISTS "Employers can create their own profile" ON public.employer_profiles;
...
-- Drop existing connection_requests policies
DROP POLICY IF EXISTS "Employers can create connection requests" ON public.connection_requests;
DROP POLICY IF EXISTS "Employers can view their own requests" ON public.connection_requests;
DROP POLICY IF EXISTS "Athletes can view requests for them" ON public.connection_requests;
DROP POLICY IF EXISTS "Admins can manage all connection requests" ON public.connection_requests;

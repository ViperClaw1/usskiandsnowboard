            ...
            {!isSignUp ? (
              showPhoneAuth ? (
                ...
                <form onSubmit={handleSignIn} className="space-y-4">
                    ...
                    <Button type="button" variant="link" className="w-full" onClick={() => setShowMagicLink(true)}>
                      Sign in with email link instead
                    </Button>

                    <Button type="button" variant="link" className="w-full" onClick={() => setShowPhoneAuth(true)}>
              ...
              showPhoneSignup ? (
                <form onSubmit={handlePhoneSignUp} className="space-y-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input id="signup-phone" type="tel" placeholder="+1 (555) 000-0000" value={phone} onChange={e => setPhone(e.target.value)} required />
                    </div>
                    <div className="space-y-2">
                      <Label htmlFor="signup-phone-code">Invite Code</Label>
                      <div className="relative">
                        <Input id="signup-phone-code" type={showInviteCode ? "text" : "password"} placeholder="Enter invite code" value={privateCode} onChange={e => setPrivateCode(e.target.value)} required className="pr-10" />
                        <Button type="button" variant="ghost" size="icon" className="absolute right-0 top-0 h-full px-3 hover:bg-transparent" onClick={() => setShowInviteCode(!showInviteCode)}>
                          {showInviteCode ? <EyeOff className="h-4 w-4 text-muted-foreground" /> : <Eye className="h-4 w-4 text-muted-foreground" />}
                        </Button>
                      </div>
                    </div>
                    <Button type="submit" className="w-full" disabled={loading}>
                ...
                <form onSubmit={handleSignUp} className="space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <Input id="signup-email" type="email" placeholder="mikaela@goat.com" value={email} onChange={e => setEmail(e.target.value)} required />
                  </div>
                  <div className="space-y-2">
                    <Label htmlFor="signup-password">Password</Label>
                    <div className="relative">
                      <Input id="signup-password" type={showSignupPassword ? "text" : "password"} value={password} onChange={e => setPassword(e.target.value)} required minLength={6} className="pr-10" />
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      <Input id="signup-code" type={showInviteCode ? "text" : "password"} placeholder="Enter invite code" value={privateCode} onChange={e => setPrivateCode(e.target.value)} required className="pr-10" />
                      <Button type="button" variant="ghost" size="icon" className="absolute right-0 top-0 h-full px-3 hover:bg-transparent" onClick={() => setShowInviteCode(!showInviteCode)}>
                        {showInviteCode ? <EyeOff className="h-4 w-4 text-muted-foreground" /> : <Eye className="h-4 w-4 text-muted-foreground" />}
                      </Button>
                    </div>

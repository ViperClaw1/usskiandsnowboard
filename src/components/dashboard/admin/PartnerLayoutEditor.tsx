        ...
        <div className="max-w-7xl mx-auto">
          <div className="flex items-center gap-6">
            ...
            <div className="flex-1">
              <h1 className="text-xl sm:text-2xl font-bold text-foreground mb-2">Welcome back, {MOCK.company}</h1>
              <Badge variant="secondary">{MOCK.industry}</Badge>
            </div>
            ...
            <CardContent>
              <div className="space-y-3">
                ...
                <Button variant="outline" className="w-full justify-start">
                  ...
                  <EditableText
                    value="Manage Opportunities"
                    textKey="quick_actions.manage_opportunities"
                    overrides={o}
                    onUpdate={updateTextOverride}
                  />
                </Button>

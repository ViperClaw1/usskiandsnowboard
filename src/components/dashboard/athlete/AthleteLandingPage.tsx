        ...
        <div className="max-w-7xl mx-auto">
          <Card className="overflow-hidden rounded-xl border shadow-elegant">
            ...
            <div className="relative overflow-visible">
              ...
              <div className="sm:mt-0 sm:absolute sm:bottom-0 sm:left-0 sm:right-0 sm:translate-y-1/2 z-10">
                <div className="flex flex-col sm:flex-row sm:items-end sm:justify-between gap-4">
                  <div className="-mt-16 flex flex-col sm:flex-row items-start gap-4 p-4 bg-white w-full rounded-t-xl sm:rounded-t-none sm:rounded-tr-xl sm:w-fit">
